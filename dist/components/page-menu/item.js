...
export default function (_a) {
    var label = _a.label, active = _a.active, icon = _a.icon, counter = _a.counter, link = _a.link, onClick = _a.onClick, rest = __rest(_a, ["label", "active", "icon", "counter", "link", "onClick"]);
    return (React.createElement(MakeButton, __assign({ offset: "0", disabled: active }, rest),
        React.createElement("a", { href: link, onClick: onClick },
